...
interface LoaderIconProps extends React.ComponentProps<any> {
    color?: string;
    type?: 'dots' | 'clock' | 'circle' | 'circle2';
}

export default function LoaderIcon({color = "#000079", type = 'circle', ...rest}: LoaderIconProps) {
    return (
        <>
