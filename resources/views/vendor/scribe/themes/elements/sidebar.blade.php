<div id="sidebar" class="sl-flex sl-overflow-y-auto sl-flex-col sl-sticky sl-inset-y-0 sl-pt-4 sl-bg-canvas-100 sl-border-r"
    ...
    <div class="sl-flex sl-items-start sl-mb-1 sl-ml-4">
        ...
        @endif
        <span class="is-logged-in" style="display: none;margin-left: 2px;width:15px;height:15px;background: #fff;border: 4px solid green;right: 4px;border-radius: 50%;top: 4px;"></span>
    </div>
