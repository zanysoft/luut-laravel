...
<head>
    ...
    <script>
        var endpint = "https://admin.luut.social";
    </script>
            <script>
            var tryItOutBaseUrl = "https://admin.luut.social";
            var useCsrf = Boolean();
...
<div class="sl-elements sl-antialiased sl-h-full sl-text-base sl-font-ui sl-text-body sl-flex sl-inset-0">
    ...
    <div class="sl-flex sl-items-start sl-mb-1 sl-ml-4">
                ...
                <img src="../../images/api-dark.png" width="160px" alt="logo">
            </div>
                                                ...
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-register">
                                                    Register
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-POSTapi-auth-login-social">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Social Login">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-auth-login-social">
                                                    Social Login
                                                </a>
                                            </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-POSTapi-auth-tokensignin">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Google Tap Login">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-auth-tokensignin">
                                                    Google Tap Login
                                                </a>
                                            </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-POSTapi-auth-email-verification-notification">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Send Verification Email">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-auth-email-verification-notification">
                                                    Send Verification Email
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-GETapi-auth-email-verify--id---hash-">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Verify Email">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-GETapi-auth-email-verify--id---hash-">
                                                    Verify Email
                                                </a>
                                            </div>
                                                                                    </div>
                                                ...
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-auth-reset-password">
                                                    Reset Password
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-auth-POSTapi-auth-login-user-reset-password">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="Reset Password">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#auth-POSTapi-auth-login-user-reset-password">
                                                    Reset Password
                                                </a>
                                            </div>
                                                                                    </div>
...
<p>Start Luut with this API.</p>
<aside>
    <strong>Base URL</strong>: <code>https://admin.luut.social/</code>
</aside>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        ...
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg">
                    ...
                    <div dir="rtl"
                         class="sl-overflow-x-hidden sl-truncate sl-text-muted endpoint-base">https://admin.luut.social</div>
...
You can check the Dev Tools console for debugging information.</p>
    ...
    "https://admin.luut.social/api/login"
);
...
$url = 'https://admin.luut.social/api/login';
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                ...
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>Must not be greater than 190 characters.</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                ...
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>Must be a valid email address. Must not be greater than 50 characters.</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
                    <div class="sl-max-w-full sl-break-all sl-px-1 sl-bg-canvas-tint sl-text-muted sl-rounded sl-border">
                        cyrus.von@example.net
                    </div>
                </div>
            </div>
            </div>
        ...
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              ...
              data-hasjsonbody="1">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                                ...
                                >{
    "first_name": "whyronp",
    "last_name": "qpgwxdcaqhcmeh",
    "email": "cyrus.von@example.net",
    "password": "(cR|>O]]l|"
}</div>
                            </div>
                                            </div>
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/register"
);
...
fetch(url, {
    ...
    body: JSON.stringify(body),
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/register';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-POSTapi-auth-login-social">
                    Social Login
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg">
                    ...
                    <div dir="rtl"
                         class="sl-overflow-x-hidden sl-truncate sl-text-muted endpoint-base">https://admin.luut.social</div>
                    <div class="sl-flex-1 sl-font-semibold">/api/auth/login/social</div>
                </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                                        <div class="sl-flex sl-items-baseline sl-text-base">
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">provider</div>
                                            <span class="sl-truncate sl-text-muted">string</span>
                                    </div>
                                    <div class="sl-flex-1 sl-h-px sl-mx-3"></div>
                    <span class="sl-ml-2 sl-text-warning">required</span>
    ...
    <div class="sl-overflow-y-hidden sl-rounded-lg">
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              data-method="POST"
              data-path="api/auth/login/social"
              data-hasfiles="0"
              data-hasjsonbody="1">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-login-social-Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-POSTapi-auth-login-social-Content-Type"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-login-social-Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-POSTapi-auth-login-social-Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                                                    <div class="TextRequestBody sl-p-4">
                                <div class="code-editor language-json"
                                     id="json-body-POSTapi-auth-login-social"
                                     style="font-family: var(--font-code); font-size: 12px; line-height: var(--lh-code);"
                                >{
    "token": "amet",
    "provider": "perspiciatis"
}</div>
                            </div>
                                            </div>
                </div>
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="POSTapi-auth-login-social"
                            class="tryItOut-btn sl-button sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-bg-primary hover:sl-bg-primary-dark active:sl-bg-primary-darker disabled:sl-bg-canvas-100 sl-text-on-primary disabled:sl-text-body sl-rounded sl-border-transparent sl-border disabled:sl-opacity-70"
                    >
                        Send Request 💥
                    </button>
            ...
            <div data-endpoint="POSTapi-auth-login-social"
                 class="tryItOut-error expandable sl-panel sl-outline-none sl-w-full" hidden>
                <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-4 sl-pl-3 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-cursor-pointer sl-select-none"
                     role="button">
                    <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/login/social"
);
...
fetch(url, {
    ...
    body: JSON.stringify(body),
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/login/social';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-POSTapi-auth-tokensignin">
                    Google Tap Login
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg">
                    ...
                    <div dir="rtl"
                         class="sl-overflow-x-hidden sl-truncate sl-text-muted endpoint-base">https://admin.luut.social</div>
                    <div class="sl-flex-1 sl-font-semibold">/api/auth/tokensignin</div>
                </div>
    ...
    <div class="sl-overflow-y-hidden sl-rounded-lg">
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              data-method="POST"
              data-path="api/auth/tokensignin"
              data-hasfiles="0"
              data-hasjsonbody="0">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-tokensignin-Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-POSTapi-auth-tokensignin-Content-Type"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-tokensignin-Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-POSTapi-auth-tokensignin-Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="POSTapi-auth-tokensignin"
                            class="tryItOut-btn sl-button sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-bg-primary hover:sl-bg-primary-dark active:sl-bg-primary-darker disabled:sl-bg-canvas-100 sl-text-on-primary disabled:sl-text-body sl-rounded sl-border-transparent sl-border disabled:sl-opacity-70"
                    >
                        Send Request 💥
                    </button>
            ...
            <div data-endpoint="POSTapi-auth-tokensignin"
                 class="tryItOut-error expandable sl-panel sl-outline-none sl-w-full" hidden>
                <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-4 sl-pl-3 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-cursor-pointer sl-select-none"
                     role="button">
                    <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/tokensignin"
);
...
fetch(url, {
    ...
    headers,
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/tokensignin';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-POSTapi-auth-email-verification-notification">
                    Send Verification Email
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg">
                    ...
                    <div dir="rtl"
                         class="sl-overflow-x-hidden sl-truncate sl-text-muted endpoint-base">https://admin.luut.social</div>
                    <div class="sl-flex-1 sl-font-semibold">/api/auth/email/verification-notification</div>
                </div>
        ...
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              ...
              data-hasjsonbody="0">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-email-verification-notification-Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-POSTapi-auth-email-verification-notification-Content-Type"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-email-verification-notification-Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-POSTapi-auth-email-verification-notification-Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="POSTapi-auth-email-verification-notification"
                            class="tryItOut-btn sl-button sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-bg-primary hover:sl-bg-primary-dark active:sl-bg-primary-darker disabled:sl-bg-canvas-100 sl-text-on-primary disabled:sl-text-body sl-rounded sl-border-transparent sl-border disabled:sl-opacity-70"
                    >
                        Send Request 💥
                    </button>
            ...
            <div data-endpoint="POSTapi-auth-email-verification-notification"
                 class="tryItOut-error expandable sl-panel sl-outline-none sl-w-full" hidden>
                <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-4 sl-pl-3 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-cursor-pointer sl-select-none"
                     role="button">
                    <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/email/verification-notification"
);
...
fetch(url, {
    ...
    headers,
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/email/verification-notification';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-GETapi-auth-email-verify--id---hash-">
                    Verify Email
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg">
                    ...
                    <div dir="rtl"
                         class="sl-overflow-x-hidden sl-truncate sl-text-muted endpoint-base">https://admin.luut.social</div>
                    <div class="sl-flex-1 sl-font-semibold">/api/auth/email/verify/{id}/{hash}</div>
                </div>
        ...
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              ...
              data-hasjsonbody="0">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                                                            <label aria-hidden="true"
                                       for="header-GETapi-auth-email-verify--id---hash--Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-GETapi-auth-email-verify--id---hash--Content-Type"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-GETapi-auth-email-verify--id---hash--Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-GETapi-auth-email-verify--id---hash--Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                            <label aria-hidden="true"
                                       for="urlparam-GETapi-auth-email-verify--id---hash--id">id</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="id" name="id"
                                               id="urlparam-GETapi-auth-email-verify--id---hash--id"
                                               ...
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                                            ...
                                                            <label aria-hidden="true"
                                       for="urlparam-GETapi-auth-email-verify--id---hash--hash">hash</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="hash" name="hash"
                                               id="urlparam-GETapi-auth-email-verify--id---hash--hash"
                                               placeholder=""
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="GETapi-auth-email-verify--id---hash-"
                            class="tryItOut-btn sl-button sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-bg-primary hover:sl-bg-primary-dark active:sl-bg-primary-darker disabled:sl-bg-canvas-100 sl-text-on-primary disabled:sl-text-body sl-rounded sl-border-transparent sl-border disabled:sl-opacity-70"
                    >
                        Send Request 💥
                    </button>
            ...
            <div data-endpoint="GETapi-auth-email-verify--id---hash-"
                 class="tryItOut-error expandable sl-panel sl-outline-none sl-w-full" hidden>
                <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-4 sl-pl-3 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-cursor-pointer sl-select-none"
                     role="button">
                    <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/email/verify/sunt/non"
);
...
fetch(url, {
    ...
    headers,
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/email/verify/sunt/non';
$response = $client-&gt;get(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-POSTapi-auth-forgot-password">
                    Forgot Password
                </h2>
            </div>
        </div>
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/forgot-password"
);
...
fetch(url, {
    ...
    body: JSON.stringify(body),
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/forgot-password';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-POSTapi-auth-reset-password">
                    Reset Password
                </h2>
            </div>
        </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                ...
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>Password should contain at-least 1 Uppercase, 1 Lowercase, 1 Numeric and 1 special character</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
        ...
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              ...
              data-hasjsonbody="1">
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                                ...
                                >{
    "token": "aut",
    "email": "ckeebler@example.org",
    "password": ";\/`2S7{7s,i1c^LmgzjK"
}</div>
                            </div>
                                            </div>
                </div>
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/reset-password"
);
...
fetch(url, {
    ...
    body: JSON.stringify(body),
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/reset-password';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
...
print_r(json_decode((string) $body));</code></pre>                                    </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="auth-POSTapi-auth-login-user-reset-password">
                    Reset Password
                </h2>
            </div>
        </div>
        ...
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--3 sl-inline-flex sl-flex-row sl-items-center sl-max-w-full sl-font-mono sl-py-2 sl-pr-4 sl-bg-canvas-50 sl-rounded-lg">
                    ...
                    <div dir="rtl"
                         class="sl-overflow-x-hidden sl-truncate sl-text-muted endpoint-base">https://admin.luut.social</div>
                    <div class="sl-flex-1 sl-font-semibold">/api/auth/login-user/reset-password</div>
                </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                    ...
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">current_password</div>
                                            <span class="sl-truncate sl-text-muted">required</span>
                                    </div>
                                    </div>
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
            <p>Current password of logged user</p>
        </div>
                                            <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-baseline sl-text-muted">
                <span>Example:</span> <!-- <span> important for spacing -->
                <div class="sl-flex sl-flex-1 sl-flex-wrap" style="gap: 4px;">
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--1 sl-flex sl-flex-1 sl-flex-col sl-items-stretch sl-max-w-full sl-ml-2 ">
        <div class="sl-flex sl-items-center sl-max-w-full">
                                        <div class="sl-flex sl-items-baseline sl-text-base">
                    <div class="sl-font-mono sl-font-semibold sl-mr-2">confirm_password</div>
                                            <span class="sl-truncate sl-text-muted">string</span>
                                    </div>
                                    </div>
                <div class="sl-prose sl-markdown-viewer" style="font-size: 12px;">
    ...
    <div class="sl-overflow-y-hidden sl-rounded-lg">
        <form class="TryItPanel sl-bg-canvas-100 sl-rounded-lg"
              data-method="POST"
              data-path="api/auth/login-user/reset-password"
              data-hasfiles="0"
              data-hasjsonbody="1">
                            <div class="sl-panel sl-outline-none sl-w-full expandable">
                    <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-4 sl-pl-3 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-cursor-pointer sl-select-none"
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                            <label aria-hidden="true"
                                   for="auth-POSTapi-auth-login-user-reset-password">Authorization</label>
                            <span class="sl-mx-3">:</span>
                            <div class="sl-flex sl-flex-1">
                                <div class="sl-input sl-flex-1 sl-relative">
                                    <code>Bearer </code>
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                        <div class="ParameterGrid sl-p-4">
                                                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-login-user-reset-password-Content-Type">Content-Type</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Content-Type" name="Content-Type"
                                               id="header-POSTapi-auth-login-user-reset-password-Content-Type"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                                                                                            <label aria-hidden="true"
                                       for="header-POSTapi-auth-login-user-reset-password-Accept">Accept</label>
                                <span class="sl-mx-3">:</span>
                                <div class="sl-flex sl-flex-1">
                                    <div class="sl-input sl-flex-1 sl-relative">
                                        <input aria-label="Accept" name="Accept"
                                               id="header-POSTapi-auth-login-user-reset-password-Accept"
                                               value="application/json" data-component="header"
                                               class="sl-relative sl-w-full sl-h-md sl-text-base sl-pr-2.5 sl-pl-2.5 sl-rounded sl-border-transparent hover:sl-border-input focus:sl-border-primary sl-border">
                                    </div>
                                </div>
                    ...
                    <div class="sl-panel__content-wrapper sl-bg-canvas-100 children" role="region">
                                                    <div class="TextRequestBody sl-p-4">
                                <div class="code-editor language-json"
                                     id="json-body-POSTapi-auth-login-user-reset-password"
                                     style="font-family: var(--font-code); font-size: 12px; line-height: var(--lh-code);"
                                >{
    "current_password": "sit",
    "password": "-85N\\(UD]tXnVW7hsH",
    "confirm_password": null
            ...
            <div class="SendButtonHolder sl-mt-4 sl-p-4 sl-pt-0">
                <div class="sl-stack sl-stack--horizontal sl-stack--2 sl-flex sl-flex-row sl-items-center">
                    <button type="button" data-endpoint="POSTapi-auth-login-user-reset-password"
                            class="tryItOut-btn sl-button sl-h-sm sl-text-base sl-font-medium sl-px-1.5 sl-bg-primary hover:sl-bg-primary-dark active:sl-bg-primary-darker disabled:sl-bg-canvas-100 sl-text-on-primary disabled:sl-text-body sl-rounded sl-border-transparent sl-border disabled:sl-opacity-70"
                    >
                        Send Request 💥
                    </button>
            ...
            <div data-endpoint="POSTapi-auth-login-user-reset-password"
                 class="tryItOut-error expandable sl-panel sl-outline-none sl-w-full" hidden>
                <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-4 sl-pl-3 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-cursor-pointer sl-select-none"
                     role="button">
                    <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/login-user/reset-password"
);
...
fetch(url, {
    ...
    body: JSON.stringify(body),
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/login-user/reset-password';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
                        ...
                        <div class="sl-panel__titlebar sl-flex sl-items-center sl-relative focus:sl-z-10 sl-text-base sl-leading-none sl-pr-3 sl-pl-4 sl-bg-canvas-200 sl-text-body sl-border-input focus:sl-border-primary sl-select-none">
                            <div class="sl-flex sl-flex-1 sl-items-center sl-h-lg">
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-javascript">const url = new URL(
    "https://admin.luut.social/api/auth/logout"
);
...
fetch(url, {
    ...
    headers,
                                ...
                                <div class="sl-px-0 sl-py-1">
                                    <div style="max-height: 400px;" class="sl-overflow-y-auto sl-rounded">
                                        <pre><code class="language-php">$client = new \GuzzleHttp\Client();
$url = 'https://admin.luut.social/api/auth/logout';
$response = $client-&gt;post(
    $url,
    [
        'headers' =&gt; [
