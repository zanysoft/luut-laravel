...
$root = rtrim(str_replace(['/', '\\'], DIRECTORY_SEPARATOR, $_SERVER['DOCUMENT_ROOT']), DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR;
$dir = trim(str_replace(['/', '\\'], DIRECTORY_SEPARATOR, $_POST['dir']), DIRECTORY_SEPARATOR);
$dir = str_replace($root, '', $dir);

if ($dir && !strpos($dir, 'public')) {
    $dir = 'public/' . $dir;
}

$main_dir = $root . str_replace($root, '', $dir);
