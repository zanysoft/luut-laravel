tinymce.Resource.add("tinymce.plugins.advcode.CodeMirror", function() {
    ...
    window.CodeMirror = void 0, t = function() {
        "use strict";
        var e = navigator.userAgent, t = navigator.platform, f = /gecko\/\d/i.test(e), n = /MSIE \d/.test(e), r = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(e), i = /Edge\/(\d+)/.exec(e), C = n || r || i, v = C && (n ? document.documentMode || 6 : +(i || r)[1]), d = !i && /WebKit\//.test(e), r = d && /Qt\/\d+\.\d+/.test(e), o = !i && /Chrome\//.test(e), p = /Opera\//.test(e), c = /Apple Computer/.test(navigator.vendor), l = /Mac OS X 1\d\D([8-9]|\d\d)\D/.test(e), u = /PhantomJS/.test(e), s = c && (/Mobile\/\w+/.test(e) || 2 < navigator.maxTouchPoints), a = /Android/.test(e), h = s || a || /webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(e), g = s || /Mac/.test(t), m = /\bCrOS\b/.test(e), y = /win/i.test(t), e = p && e.match(/Version\/(\d*\.\d*)/);
        (e = e && Number(e[1])) && 15 <= e && (d = !(p = !1));
        var b = g && (r || p && (null == e || e < 12.11)), x = f || C && 9 <= v;
        function w(e) {
            return new RegExp("(^|\\s)" + e + "(?:$|\\s)\\s*");
        }
        var S, k = function(e, t) {
            var n = e.className, r = w(t).exec(n);
        ...
        function D(e, t) {
            for (var n = e.split(" "), r = 0; r < n.length; r++) n[r] && !w(n[r]).test(t) && (t += " " + n[r]);
            return t;
        }
        ...
        E.prototype.onTimeout = function(e) {
            ...
            this.f = t;
            t = +new Date() + e;
            (!this.id || t < this.time) && (clearTimeout(this.id), this.id = setTimeout(this.handler, e), 
            this.time = t);
        };
        var B = 50, z = {
            toString: function() {
        ...
        de = /[1n]/, function(e, t) {
            ...
            for (var m = 0; m < i; ++m) {
                ...
                if ("," == v) o[m] = "N"; else if ("%" == v) {
                    ...
                    for (var b = m && "!" == o[m - 1] || y < i && "1" == o[y] ? "1" : "N", C = m; C < y; ++C) o[C] = b;
                    m = y - 1;
                }
            }
            for (var x = 0, w = n; x < i; ++x) {
                var S = o[x];
                "L" == w && "1" == S ? o[x] = "L" : he.test(S) && (w = S);
            }
            ...
            for (var O, A = [], F = 0; F < i; ) if (fe.test(o[F])) {
                ...
                var P = F, W = A.length, H = "rtl" == t ? 1 : 0;
                for (++F; F < i && "L" != o[F]; ++F) ;
                for (var I = P; I < F; ) if (de.test(o[I])) {
                    P < I && (A.splice(W, 0, new ge(1, P, I)), W += H);
                    var E = I;
                    for (++I; I < F && de.test(o[I]); ++I) ;
                    A.splice(W, 0, new ge(2, E, I)), W += H, P = I;
                } else ++I;
                P < F && A.splice(W, 0, new ge(1, P, F));
            }
        ...
        }, Ee = "oncopy" in (r = M("div")) || (r.setAttribute("oncopy", "return;"), "function" == typeof r.oncopy), Re = null;
        var Be = {}, ze = {};
        function Ue(e) {
        ...
        function xt(e, t, n, r) {
            ...
            r && o.push(new Ct(c, i, qe(l.mode, u.state)));
            return r ? o : new Ct(c, i, u.state);
        }
        function wt(e, t) {
            if (e) for (;;) {
        ...
        function St(e, t, n, r, i, o, l) {
            ...
            for ("" == t && wt(yt(n, r.state), o); !c.eol(); ) {
                var f, d = c.pos > e.options.maxHighlightLength ? (s = !1, l && vt(e, t, r, c.pos), 
                c.pos = t.length, null) : wt(bt(n, c, r.state, h), o);
        ...
        function Nt(e, t) {
            ...
            var i = t.from.ch, o = t.to.ch, e = 0 == it(t.from, t.to), l = function(e, t, n) {
                ...
                if (e) for (var i = 0; i < e.length; ++i) {
                    ...
                    (r = r || []).push(new Tt(s, o ? null : l.from - t, null == l.to ? null : l.to - t)));
                }
                return r;
            }(r, o, e), a = 1 == t.text.length, u = _(t.text).length + (a ? i : 0);
            if (l) for (var c = 0; c < l.length; ++c) {
                var h, f = l[c];
                null == f.to && ((h = Mt(s, f.marker)) ? a && (f.to = null == h.to ? null : h.to + u) : f.to = i);
            }
            if (s) for (var d = 0; d < s.length; ++d) {
                var p = s[d];
                null != p.to && (p.to += u), null == p.from ? Mt(l, p.marker) || (p.from = u, a && (l = l || []).push(p)) : (p.from += u, 
                a && (l = l || []).push(p));
            }
        ...
        function Wt(e, t) {
            ...
            if (n) return -n;
            i = it(r.to, i.to) || Pt(e) - Pt(t);
            return i || t.id - e.id;
        }
        function Ht(e, t) {
            var n, r = Lt && e.markedSpans;
            if (r) for (var i, o = 0; o < r.length; ++o) (i = r[o]).marker.collapsed && null == (t ? i.from : i.to) && (!n || Wt(n, i.marker) < 0) && (n = i.marker);
            return n;
        }
        function It(e) {
            return Ht(e, !0);
        ...
        function Rt(e, t, n, r, i) {
            ...
            if (o) for (var l = 0; l < o.length; ++l) {
                ...
                if (s.marker.collapsed) {
                    var a = s.marker.find(0), u = it(a.from, n) || Dt(s.marker) - Dt(i), c = it(a.to, r) || Pt(s.marker) - Pt(i);
        ...
        function Yt(e, t) {
            ...
            for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                ...
                r.pos = 0, r.addToken = Qt, function(e) {
                    ...
                    var t = T(e, document.createTextNode("A\u062eA")), n = S(t, 0, 1).getBoundingClientRect(), t = S(t, 1, 2).getBoundingClientRect();
                    return L(e), n && n.left != n.right && (Pe = t.right - n.right < 3);
                    ...
                    for (var s, a, u, c, h, f, d, p = i.length, g = 0, m = 1, v = "", y = 0; ;) {
                        if (y == g) {
                            ...
                            for (var b = [], C = void 0, x = 0; x < r.length; ++x) {
                                var w = r[x], S = w.marker;
                                if ("bookmark" == S.type && w.from == g && S.widgetNode) b.push(S); else if (w.from <= g && (null == w.to || w.to > g || S.collapsed && w.to == g && w.from == g)) {
                                    if (null != w.to && w.to != g && y > w.to && (y = w.to, c = ""), S.className && (u += " " + S.className), 
                                    S.css && (a = (a ? a + ";" : "") + S.css), S.startStyle && w.from == g && (h += " " + S.startStyle), 
                                    S.endStyle && w.to == y && (C = C || []).push(S.endStyle, w.to), S.title && ((d = d || {}).title = S.title), 
                                    S.attributes) for (var k in S.attributes) (d = d || {})[k] = S.attributes[k];
                                    S.collapsed && (!f || Wt(f.marker, S) < 0) && (f = w);
                                } else w.from > g && y > w.from && (y = w.from);
                            }
                            if (C) for (var L = 0; L < C.length; L += 2) C[L + 1] == y && (c += " " + C[L]);
                            if (!f || f.from == g) for (var T = 0; T < b.length; ++T) Jt(t, 0, b[T]);
                            if (f && (f.from || 0) == g) {
                        ...
                        for (var M = Math.min(p, y); ;) {
                            if (v) {
                                var N, O = g + v.length;
                                if (f || (N = M < O ? v.slice(0, M - g) : v, t.addToken(t, N, s ? s + u : u, h, g + N.length == y ? c : "", a, d)), 
                                M <= O) {
                                    v = v.slice(M - g), g = M;
                                    break;
                                }
                ...
                0 == r.map.length && r.map.push(0, 0, r.content.appendChild(function(e) {
                    null == De && (t = M("span", "\u200b"), T(e, M("span", [ t, document.createTextNode("x") ])), 
                    0 != e.firstChild.offsetHeight && (De = t.offsetWidth <= 1 && 2 < t.offsetHeight && !(C && v < 8)));
                    var t = De ? M("span", "\u200b") : M("span", "\xa0", null, "display: inline-block; width: 1px; margin-right: -1px");
            ...
            if (t) {
                ...
                if (u.test(t)) {
                    ...
                    for (var h = 0; ;) {
                        ...
                        if (d && (p = document.createTextNode(a.slice(h, h + d)), C && v < 9 ? s.appendChild(M("span", [ p ])) : s.appendChild(p), 
                        e.map.push(e.pos, e.pos + d, p), e.col += d, e.pos += d), !f) break;
                        h += 1 + d;
                        var p = void 0;
                        "\t" == f[0] ? (d = (d = e.cm.options.tabSize) - e.col % d, (p = s.appendChild(M("span", j(d), "cm-tab"))).setAttribute("role", "presentation"), 
                        p.setAttribute("cm-text", "\t"), e.col += d) : ("\r" == f[0] || "\n" == f[0] ? (p = s.appendChild(M("span", "\r" == f[0] ? "\u240d" : "\u2424", "cm-invalidchar"))).setAttribute("cm-text", f[0]) : ((p = e.cm.options.specialCharPlaceholder(f[0])).setAttribute("cm-text", f[0]), 
                        C && v < 9 ? s.appendChild(M("span", [ p ])) : s.appendChild(p)), e.col += 1), e.map.push(e.pos, e.pos + 1, p), 
                        e.pos++;
                    }
                } else e.col += t.length, s = document.createTextNode(a), e.map.push(e.pos, e.pos + t.length, s), 
                C && v < 9 && (c = !0), e.pos += t.length;
        ...
        function an(e, t, n, r) {
            for (var i = 0; i < t.changes.length; i++) {
                ...
                "text" == o ? function(e, t) {
                    ...
                    for (var r = w("CodeMirror-linewidget"), i = t.node.firstChild, o = void 0; i; i = o) o = i.nextSibling, 
        ...
        function un(e) {
            ...
            C && v < 8 && (e.node.style.zIndex = 2)), e.node;
        }
        function cn(e, t) {
        ...
        function hn(e, t) {
            ...
            i.background = null) : r && (e = un(i), i.background = e.insertBefore(M("div", null, r), e.firstChild), 
        ...
        function fn(e, t, n, r) {
            ...
            t.gutterBackground = null), t.line.gutterClass && (o = un(t), t.gutterBackground = M("div", null, "CodeMirror-gutter-background " + t.line.gutterClass, "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px; width: " + r.gutterTotalWidth + "px"), 
            ...
            if (e.options.lineNumbers || i) {
                var o = un(t), l = t.gutter = M("div", null, "CodeMirror-gutter-wrapper", "left: " + (e.options.fixedGutter ? r.fixedPos : -r.gutterTotalWidth) + "px");
                if (l.setAttribute("aria-hidden", "true"), e.display.input.setUneditable(l), o.insertBefore(l, t.text), 
                t.line.gutterClass && (l.className += " " + t.line.gutterClass), !e.options.lineNumbers || i && i["CodeMirror-linenumbers"] || (t.lineNumber = l.appendChild(M("div", nt(e.options, n), "CodeMirror-linenumber CodeMirror-gutter-elt", "left: " + r.gutterLeft["CodeMirror-linenumbers"] + "px; width: " + e.display.lineNumInnerWidth + "px"))), 
        ...
        function gn(e) {
            ...
            e.noHScroll && (t += "width: " + n.display.wrapper.clientWidth + "px;"), T(n.display.measure, M("div", [ e.node ], null, t))), 
        ...
        function bn(e) {
            ...
            var t = T(e.measure, M("pre", "x", "CodeMirror-line-like")), t = window.getComputedStyle ? window.getComputedStyle(t) : t.currentStyle, t = {
        ...
        function Tn(e, t) {
            ...
            o || (n = e, e = Je(r = Bt(r = t)), (r = n.display.externalMeasured = new en(n.doc, r, e)).lineN = e, 
            e = r.built = Yt(n, r), r.text = e.pre, T(n.display.lineMeasure, e.pre), o = r);
            i = Sn(o, t, i);
            return {
                line: t,
                view: o,
            ...
            t.hasHeights || (function(e, t, n) {
                ...
                if (3 == l.nodeType) {
                    for (var c = 0; c < 4; c++) {
                        ...
                        if ((i = C && v < 9 && 0 == s && a == o.coverEnd - o.coverStart ? l.parentNode.getBoundingClientRect() : function(e, t) {
                            var n = On;
                ...
                {
                    !(C && v < 9) || s || i && (i.left || i.right) || (m = l.parentNode.getClientRects()[0], 
                    i = m ? {
                        left: m.left,
        ...
        function En(e, t, n, r, i) {
            ...
            r = e.left + ("window" == r ? 0 : Wn()), n.left += r, n.right += r), n.top += t, 
            n.bottom += t, n;
        }
        function Rn(e, t, n) {
            if ("div" == n) return t;
            var r = t.left, t = t.top;
            "page" == n ? (r -= Wn(), t -= Hn()) : "local" != n && n || (r += (n = e.display.sizer.getBoundingClientRect()).left, 
            t += n.top);
        ...
        function Gn(e, t, n) {
            ...
            if (o < i) return Kn(r.first + r.size - 1, Xe(r, o).text.length, null, 1, 1);
            t < 0 && (t = 0);
            for (var l = Xe(r, i); ;) {
                var s = function(n, e, t, r, i) {
                    i -= Gt(e);
                    var o = Tn(n, e), l = In(e), s = 0, a = e.text.length, u = !0, c = me(e, n.doc.direction);
                    {
                        c && (d = (n.options.lineWrapping ? function(e, t, n, r, i, o, l) {
                            ...
                            for (var u = null, c = null, h = 0; h < i.length; h++) {
                                var f, d = i[h];
                                d.from >= a || d.to <= s || (f = 1 != d.level, f = Mn(e, r, f ? Math.min(a, d.to) - 1 : Math.max(s, d.from)).right, 
                            ...
                            var e = ie(function(e) {
                                ...
                                return jn(zn(n, rt(i, e ? t.to : t.from, e ? "before" : "after"), "line", r, o), s, a, !0);
                            }, 0, l.length - 1), t = l[e];
                            {
                                var u;
                                0 < e && (u = 1 != t.level, jn(u = zn(n, rt(i, u ? t.from : t.to, u ? "after" : "before"), "line", r, o), s, a, !0) && u.top > a && (t = l[e - 1]));
                            }
                            return t;
                    ...
                    }, s, a), d = !1;
                    {
                        ...
                        p = p ? f.left : f.right) : (u || c != a && c != s || c++, g = 0 == c || c != e.text.length && Mn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before", 
                        u = zn(n, rt(t, c, g), "line", e, o), p = u.left, d = i < u.top ? -1 : i >= u.bottom ? 1 : 0);
                    }
        ...
        function qn(e, t, n, r) {
            return Vn(e, t, n = n || Tn(e, t), En(e, t, Mn(e, n, r), "line").top);
        }
        function jn(e, t, n, r) {
        ...
        function Jn(e, t, n, r) {
            ...
            var a, i = Gn(e, o, l);
            return r && 0 < i.xRel && (a = Xe(e.doc, i.line).text).length == i.ch && (a = I(a, a.length, e.options.tabSize) - a.length, 
        ...
        function tr(e, t, n, r) {
            ...
            e.curOp.viewChanged = !0, t >= l.viewTo ? Lt && zt(e.doc, t) < l.viewTo && rr(e) : n <= l.viewFrom ? Lt && Ut(e.doc, n + r) > l.viewFrom ? rr(e) : (l.viewFrom += r, 
            ...
            for (var n, r, i = e.doc, o = {}, l = o.cursors = document.createDocumentFragment(), s = o.selection = document.createDocumentFragment(), a = 0; a < i.sel.ranges.length; a++) {
                ...
                r || function(i, e, t) {
                    ...
                    function s(n, g, m) {
                        ...
                        function C(e, t) {
                            return Bn(i, rt(n, e), "div", r, t);
                        }
                        function x(e, t, n) {
                            e = qn(i, r, null, e), t = "ltr" == t == ("after" == n) ? "left" : "right";
                            return C("after" == n ? e.begin : e.end - (/\s/.test(r.text.charAt(e.end - 1)) ? 2 : 1), t)[t];
                        }
                        var w = me(r, o.direction);
                        return function(e, t, n, r) {
                            ...
                            i || r(t, n, "ltr");
                        }(w, g || 0, null == m ? b : m, function(e, t, n, r) {
                            var i, o, l, s, a = "ltr" == n, u = C(e, a ? "left" : "right"), c = C(t - 1, a ? "right" : "left"), h = null == g && 0 == e, f = null == m && t == b, d = 0 == r, p = !w || r == w.length - 1;
                            c.top - u.top <= 3 ? (i = (L ? f : h) && p, r = (L ? h : f) && d ? S : (a ? u : c).left, 
                            i = i ? k : (a ? c : u).right, T(r, u.top, i - r, u.bottom)) : (n = a ? (o = L && h && d ? S : u.left, 
                            ...
                            T(o, u.top, l - o, u.bottom), u.bottom < c.top && T(S, u.bottom, null, c.top), T(s, c.top, n - s, c.bottom)), 
                    ...
                    var a = e.from(), n = e.to();
                    {
                        ...
                        e = Bt(r) == Bt(e), r = s(a.line, a.ch, e ? r.text.length + 1 : null).end, n = s(n.line, e ? 0 : null, n.ch).start, 
        ...
        function ar(e, t, n) {
            var r = zn(e, t, "div", null, null, !e.options.singleCursorHeightPerLine), t = n.appendChild(M("div", "\xa0", "CodeMirror-cursor"));
            t.style.left = r.left + "px", t.style.top = r.top + "px", t.style.height = Math.max(0, r.bottom - r.top) * e.options.cursorHeight + "px", 
            r.other && ((n = n.appendChild(M("div", "\xa0", "CodeMirror-cursor CodeMirror-secondarycursor"))).style.display = "", 
        ...
        function hr(e) {
            e.hasFocus() || (e.display.input.focus(), e.state.focused || dr(e));
        }
        function fr(e) {
        ...
        function dr(e, t) {
            ...
            "nocursor" != e.options.readOnly && (e.state.focused || (xe(e, "focus", e, t), e.state.focused = !0, 
            F(e.display.wrapper, "CodeMirror-focused"), e.curOp || e.display.selForContextMenu == e.doc.sel || (e.display.input.reset(), 
        ...
        function gr(e) {
            for (var t = e.display, n = t.lineDiv.offsetTop, r = 0; r < t.view.length; r++) {
                ...
                if (!o.hidden) {
                    C && v < 8 ? (s = (i = o.node.offsetTop + o.node.offsetHeight) - n, n = i) : (s = (u = o.node.getBoundingClientRect()).bottom - u.top, 
        ...
        function yr(e, t) {
            ...
            t.top < 0 && (t.top = 0);
            var i = (e.curOp && null != e.curOp.scrollTop ? e.curOp : n.scroller).scrollTop, o = wn(e), l = {};
            ...
            var i = e.options.fixedGutter ? 0 : n.gutters.offsetWidth, u = e.curOp && null != e.curOp.scrollLeft ? e.curOp.scrollLeft : n.scroller.scrollLeft - i, e = xn(e) - n.gutters.offsetWidth, n = t.right - t.left > e;
            return n && (t.right = t.left + e), t.left < 10 ? l.scrollLeft = 0 : t.left < u ? l.scrollLeft = Math.max(0, t.left + i - (n ? 0 : 10)) : t.right > e + u - 3 && (l.scrollLeft = t.right + (n ? 0 : 10) - e), 
            l;
        }
        function br(e, t) {
            null != t && (wr(e), e.curOp.scrollTop = (null == e.curOp.scrollTop ? e.doc : e.curOp).scrollTop + t);
        }
        function Cr(e) {
            wr(e);
            var t = e.getCursor();
        ...
        function xr(e, t, n) {
            null == t && null == n || wr(e), null != t && (e.curOp.scrollLeft = t), null != n && (e.curOp.scrollTop = n);
        }
        function wr(e) {
        ...
        e = function(e, t, n) {
            ...
            }), this.checkedZeroWidth = !1, C && v < 8 && (this.horiz.style.minHeight = this.vert.style.minWidth = "18px");
        };
        ...
        function Nr(e, t) {
            ...
            Or(e, Mr(e)), n = e.display.barWidth, r = e.display.barHeight;
        }
        function Or(e, t) {
            ...
            e && rn(e, function(e) {
                ...
                !function(e) {
                    ...
                    for (var i = 0; i < t.length; i++) !function(e) {
                        ...
                        e.barMeasure = Mr(t), n.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = kn(t, n.maxLine, n.maxLine.text.length).left + 3, 
                    ...
                    for (var l = 0; l < t.length; l++) !function(e) {
                        ...
                        null != e.scrollLeft && Tr(t, e.scrollLeft, !0, !0);
                        {
                            ...
                            e.scrollToPos && (i = function(e, t, n, r) {
                                ...
                                for (var i = 0; i < 5; i++) {
                                    var o, l = !1, s = zn(e, t), a = n && n != t ? zn(e, n) : s, u = yr(e, o = {
                                    ...
                                    null != u.scrollLeft && (Tr(e, u.scrollLeft), 1 < Math.abs(e.doc.scrollLeft - a) && (l = !0)), 
                                    !l) break;
                                }
                                return o;
        ...
        function Br(e, t) {
            e.doc.highlightFrontier < e.display.viewTo && e.state.highlight.set(t, W(zr, e));
        }
        function zr(l) {
            var s, a, u, c = l.doc;
            ...
            a = mt(l, c.highlightFrontier), u = [], c.iter(a.line, Math.min(c.first + c.size, l.display.viewTo + 500), function(e) {
                ...
                a.nextLine();
                if (+new Date() > s) return Br(l, l.options.workDelay), !0;
        ...
        function Kr(e, t) {
            ...
            (i = l) && i.activeElt && i.activeElt != A() && (i.activeElt.focus(), !/^(INPUT|TEXTAREA)$/.test(i.activeElt.nodeName) && i.anchorNode && O(document.body, i.anchorNode) && O(document.body, i.focusNode) && (o = window.getSelection(), 
            ...
            n.lastWrapWidth = t.wrapperWidth, Br(e, 400)), !(n.updateLineNumbers = null);
        }
        function Gr(e, t) {
            for (var n = t.viewport, r = !0; ;r = !1) {
                if (r && e.options.lineWrapping && t.oldDisplayWidth != xn(e)) r && (t.visible = vr(e.display, e.doc, n)); else if (n && null != n.top && (n = {
                    top: Math.min(e.doc.height + yn(e.display) - wn(e), n.top)
                }), t.visible = vr(e.display, e.doc, n), t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo) break;
                if (!Kr(e, t)) break;
                gr(e);
                var i = Mr(e);
        ...
        function Vr(e, t) {
            var n = new Ur(e, t);
            Kr(e, n) && (gr(e), Gr(e, n), t = Mr(e), lr(e), Nr(e, t), jr(e, t), n.finish());
        }
        function qr(e) {
        ...
        function $r(e) {
            if (e.options.lineNumbers) {
                ...
                if (n.length != r.lineNumChars) {
                    var i = r.measure.appendChild(M("div", [ M("div", n) ], "CodeMirror-linenumber CodeMirror-gutter-elt")), t = i.firstChild.offsetWidth, i = i.offsetWidth - t;
        ...
        function Yr(e) {
            ...
            for (var r = 0; r < n.length; ++r) {
                var i = n[r], o = i.className, l = i.style, i = t.appendChild(M("div", null, "CodeMirror-gutter " + o));
        ...
        function Qr(e, t, n, r) {
            var i = this;
            this.input = n, i.scrollbarFiller = M("div", null, "CodeMirror-scrollbar-filler"), 
            i.scrollbarFiller.setAttribute("cm-not-content", "true"), i.gutterFiller = M("div", null, "CodeMirror-gutter-filler"), 
            i.gutterFiller.setAttribute("cm-not-content", "true"), i.lineDiv = N("div", null, "CodeMirror-code"), 
            i.selectionDiv = M("div", null, null, "position: relative; z-index: 1"), i.cursorDiv = M("div", null, "CodeMirror-cursors"), 
            i.measure = M("div", null, "CodeMirror-measure"), i.lineMeasure = M("div", null, "CodeMirror-measure"), 
            ...
            i.mover = M("div", [ o ], null, "position: relative"), i.sizer = M("div", [ i.mover ], "CodeMirror-sizer"), 
            i.sizerWidth = null, i.heightForcer = M("div", null, null, "position: absolute; height: " + B + "px; width: 1px;"), 
            i.gutters = M("div", null, "CodeMirror-gutters"), i.lineGutter = null, i.scroller = M("div", [ i.sizer, i.heightForcer, i.gutters ], "CodeMirror-scroll"), 
            i.scroller.setAttribute("tabIndex", "-1"), i.wrapper = M("div", [ i.scrollbarFiller, i.gutterFiller, i.scroller ], "CodeMirror"), 
            C && v < 8 && (i.gutters.style.zIndex = -1, i.scroller.style.paddingRight = 0), 
        ...
        function ri(e, t) {
            ...
            if (r && s || i && a) {
                ...
                Tr(e, Math.max(0, l.scrollLeft + r * ei)), (!i || i && a) && Te(t), void (o.wheelStartX = null);
        ...
        C ? ei = -.53 : f ? ei = 15 : o ? ei = -.7 : c && (ei = -1 / 3);
        var ii = function(e, t) {
        ...
        function di(e) {
            ...
            }), e.doc.modeFrontier = e.doc.highlightFrontier = e.doc.first, Br(e, 100), e.state.modeGen++, 
            e.curOp && tr(e);
        }
        function pi(e, t) {
        ...
        function bi(e) {
            this.done = [], this.undone = [], this.undoDepth = e ? e.undoDepth : 1 / 0, this.lastModTime = this.lastSelTime = 0, 
        ...
        function wi(e, t, n, r) {
            ...
            _(a.done)) : void 0)) l = _(o.changes), 0 == it(t.from, t.to) && 0 == it(t.from, l.to) ? l.to = ai(t) : o.changes.push(Ci(e, t)); else {
                var a = _(i.done);
        ...
        function Ii(e, t, n) {
            ...
            Ei(e, Bi(e, t, o, !0)), n && !1 === n.scroll || !e.cm || "nocursor" == e.cm.getOption("readOnly") || Cr(e.cm);
        }
        function Ei(e, t) {
        ...
        function zi(e, t, n, r, i) {
            ...
            if (o.markedSpans) for (var l = 0; l < o.markedSpans.length; ++l) {
                var s = o.markedSpans[l], a = s.marker, u = "selectLeft" in a ? !a.selectLeft : a.inclusiveLeft, c = "selectRight" in a ? !a.selectRight : a.inclusiveRight;
                if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                    ...
                    if (a.atomic) {
                        if (n) {
                            ...
                            if ((r < 0 ? c : u) && (h = Ki(e, h, -r, h && h.line == t.line ? o : null)), h && h.line == t.line && (s = it(h, n)) && (r < 0 ? s < 0 : 0 < s)) return zi(e, h, t, r, i);
                        }
                        a = a.find(r < 0 ? -1 : 1);
                        return (r < 0 ? u : c) && (a = Ki(e, a, r, a.line == t.line ? o : null)), a ? zi(e, a, t, r, i) : null;
                    }
                }
            }
            return t;
        ...
        function Ui(e, t, n, r, i) {
            r = r || 1, r = zi(e, t, n, r, i) || !i && zi(e, t, n, r, !0) || zi(e, t, n, -r, i) || !i && zi(e, t, n, -r, !0);
        ...
        function ji(e, n) {
            ...
            wi(e, n, t, e.cm ? e.cm.curOp.id : NaN), Xi(e, n, t, Nt(e, n)), r = [], mi(e, function(e, t) {
                ...
                if (u != s.length) {
                    ...
                    for (var h = ke(i, "beforeChange") || i.cm && ke(i.cm, "beforeChange"), f = l.changes.length - 1; 0 <= f; --f) {
                        var d = function(e) {
                            ...
                            c.push(Ci(i, n));
                            var t = e ? ci(i, n) : _(s);
                            Xi(i, n, t, Mi(i, n)), !e && i.cm && i.cm.scrollIntoView({
                                from: n.from,
                                to: ai(n)
                            });
                            var r = [];
                            mi(i, function(e, t) {
                                t || -1 != R(r, e.history) || (Ji(e.history, n), r.push(e.history)), Xi(e, n, null, Mi(e, n));
                            });
                        }(f);
                        if (d) return d.v;
                    }
        ...
        function Xi(e, t, n, r) {
            ...
            t = {
                ...
                e.options.lineWrapping || (a = Je(Bt(Xe(r, o.line))), r.iter(a, l.line + 1, function(e) {
            ...
            }(e.cm, t, r) : gi(e, t, r), Ii(e, n, U), e.cantEdit && Ui(e, rt(e.firstLine(), 0)) && (e.cantEdit = !1));
        }
        ...
        function so(t, n, r, e, i) {
            ...
            if (t.iter(s, r.line + 1, function(e) {
                var t;
                a && o.collapsed && !a.options.lineWrapping && Bt(e) == a.display.maxLine && (l = !0), 
                o.collapsed && s != n.line && Qe(e, 0), t = e, e = new Tt(o, s == n.line ? n.ch : null, s == r.line ? r.ch : null), 
        ...
        lo.prototype.clear = function() {
            if (!this.explicitlyCleared) {
                ...
                n && Pr(t), !ke(this, "clear") || (e = this.find()) && ln(this, "clear", e.from, e.to);
                for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                    var l = this.lines[o], s = Mt(l.markedSpans, this);
                    t && !this.collapsed ? nr(t, Je(l), "text") : t && (null != s.to && (i = Je(l)), 
                    null != s.from && (r = Je(l))), l.markedSpans = function(e, t) {
                        for (var n, r = 0; r < e.length; ++r) e[r] != t && (n = n || []).push(e[r]);
                        return n;
                    }(l.markedSpans, s), null == s.from && this.collapsed && !Kt(this.doc, l) && t && Qe(l, _n(t.display));
                }
                if (t && this.collapsed && !t.options.lineWrapping) for (var a = 0; a < this.lines.length; ++a) {
                    var u = Bt(this.lines[a]), c = Vt(u);
                    c > t.display.maxLineLength && (t.display.maxLine = u, t.display.maxLineLength = c, 
                    t.display.maxLineChanged = !0);
                }
                null != r && t && this.collapsed && tr(t, r, i + 1), this.lines.length = 0, this.explicitlyCleared = !0, 
                this.atomic && this.doc.cantEdit && (this.doc.cantEdit = !1, t && Ri(t.doc)), t && ln(t, "markerCleared", t, this, r, i), 
                n && Wr(t), this.parent && this.parent.clear();
            }
        ...
        ho.prototype = Y(no.prototype, {
            ...
            getLineHandleVisualStart: function(e) {
                return "number" == typeof e && (e = Xe(this, e)), Bt(e);
            },
            lineCount: function() {
                return this.size;
            },
            ...
            setCursor: Rr(function(e, t, n) {
                Pi(this, ct(this, "number" == typeof e ? rt(e, t || 0) : e), null, n);
            }),
            setSelection: Rr(function(e, t, n) {
                Pi(this, ct(this, e), ct(this, t || e), n);
            }),
            ...
            replaceSelections: Rr(function(e, t, n) {
                ...
                t ? Wi(this, t) : this.cm && Cr(this.cm);
            }),
            undo: Rr(function() {
                _i(this, "undo");
            }),
            ...
            unlinkDoc: function(e) {
                if (e instanceof ul && (e = e.doc), this.linked) for (var t = 0; t < this.linked.length; ++t) {
                    if (this.linked[t].doc == e) {
                        this.linked.splice(t, 1), e.unlinkDoc(this), function(o) {
            ...
            if (go(r), !we(r, e) && !mn(r.display, e)) {
                ...
                if (t && !r.isReadOnly()) if (n && n.length && window.FileReader && window.File) for (var i = n.length, o = Array(i), l = 0, s = function() {
                    ++l == i && Ir(r, function() {
                        ...
                        qi(r.doc, e), Wi(r.doc, si(ct(r.doc, t), ct(r.doc, ai(e))));
                    })();
                }, a = 0; a < n.length; a++) !function(e, t) {
                    var n;
                    r.options.allowDropFileTypes && -1 == R(r.options.allowDropFileTypes, e.type) ? s() : ((n = new FileReader()).onerror = s, 
                    n.onload = function() {
                        var e = n.result;
                        /[\x00-\x08\x0e-\x1f]{2}/.test(e) || (o[t] = e), s();
                    }, n.readAsText(e));
                }(n[a], a); else {
                    if (r.state.draggingText && -1 < r.doc.sel.contains(t)) return r.state.draggingText(e), 
                    ...
                    try {
                        ...
                        if (c) {
                            ...
                            Ii(r.doc, si(t, t)), u) for (var h = 0; h < u.length; ++h) Yi(r.doc, "", u[h].anchor, u[h].head, "drag");
        ...
        for (var Co = {
            ...
            63277: "PageDown",
            63302: "Insert"
        }, xo = 0; xo < 10; xo++) Co[xo + 48] = Co[xo + 96] = String(xo);
        for (var wo = 65; wo <= 90; wo++) Co[wo] = String.fromCharCode(wo);
        for (var So = 1; So <= 12; So++) Co[So + 111] = Co[So + 63235] = "F" + So;
        var ko = {};
        function Lo(e) {
        ...
        function No(e) {
            e = "string" == typeof e ? e : Co[e.keyCode];
            return "Ctrl" == e || "Alt" == e || "Shift" == e || "Mod" == e;
        }
        function Oo(e, t, n) {
            var r = e;
            return t.altKey && "Alt" != r && (e = "Alt-" + e), (b ? t.metaKey : t.ctrlKey) && "Ctrl" != r && (e = "Ctrl-" + e), 
            (b ? t.ctrlKey : t.metaKey) && "Mod" != r && (e = "Cmd-" + e), !n && t.shiftKey && "Shift" != r && (e = "Shift-" + e), 
            e;
        }
        function Ao(e, t) {
        ...
        function Ho(e, t, n, r, i) {
            if (e) {
                ...
                if (o) {
                    ...
                    return 0 < e.level || "rtl" == t.doc.direction ? (l = Tn(t, n), s = i < 0 ? n.text.length - 1 : 0, 
                    a = Mn(t, l, s).top, s = ie(function(e) {
                        return Mn(t, l, e).top == a;
                    }, i < 0 == (1 == e.level) ? e.from : e.to - 1, s), "before" == o && (s = Po(n, s, 1))) : s = i < 0 ? e.to : e.from, 
                    new rt(r, s, o);
                }
            }
        ...
        function Io(t, n, s, e) {
            ...
            if (!a) return Wo(n, s, e);
            s.ch >= n.text.length ? (s.ch = n.text.length, s.sticky = "before") : s.ch <= 0 && (s.ch = 0, 
            s.sticky = "after");
            var r = le(a, s.ch, s.sticky), i = a[r];
            if ("ltr" == t.doc.direction && i.level % 2 == 0 && (0 < e ? i.to > s.ch : i.from < s.ch)) return Wo(n, s, e);
            function u(e, t) {
                return Po(n, e instanceof rt ? e.ch : e, t);
            }
            function o(e) {
                return t.options.lineWrapping ? (l = l || Tn(t, n), qn(t, n, l, e)) : {
                    begin: 0,
                    end: n.text.length
                };
            }
        ...
        function Vo(t, e) {
            ...
            return !!n && (e.shiftKey && !t.state.keySeq ? Ko(t, "Shift-" + n, e, function(e) {
                ...
                if ("string" == typeof e ? /^go[A-Z]/.test(e) : e.motion) return zo(t, e);
            }) : Ko(t, n, e, function(e) {
                return zo(t, e);
            }));
        }
        ...
        function jo(e) {
            var t, n, r, i = this;
            function o(e) {
                18 != e.keyCode && e.altKey || (k(r, "CodeMirror-crosshair"), Ce(document, "keyup", o), 
                Ce(document, "mouseover", o));
            }
            e.target && e.target != i.display.input.getField() || (i.curOp.focus = A(), we(i, e) || (C && v < 11 && 27 == e.keyCode && (e.returnValue = !1), 
            ...
            f && !g && !n && 46 == t && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"), 
        ...
        function $o(e) {
            var t = this;
            if (!(e.target && e.target != t.display.input.getField() || mn(t.display, e) || we(t, e) || e.ctrlKey && !e.altKey || g && e.metaKey)) {
                var n, r = e.keyCode, i = e.charCode;
                if (p && r == qo) return qo = null, void Te(e);
        ...
        function Qo(e) {
            ...
            window.focus(), 1 == n && l.state.selectingText && l.state.selectingText(e), t && function(n, e, r, t, i) {
                ...
                return Ko(n, Oo(o = (1 == e ? "Left" : 2 == e ? "Middle" : "Right") + o, i), i, function(e) {
                    ...
                    var t = !1;
                    try {
                        n.isReadOnly() && (n.state.suppressEdits = !0), t = e(n, r) != z;
                    } finally {
                ...
                C ? setTimeout(W(hr, e), 0) : e.curOp.focus = A();
                ...
                (e.options.dragDrop && We && !e.isReadOnly() && "single" == n && -1 < (i = l.contains(t)) && (it((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) && (0 < it(i.to(), t) || t.xRel < 0) ? function(t, n, r, i) {
                    var o = t.display, l = !1, s = Ir(t, function(e) {
                        d && (o.scroller.draggable = !1), t.state.draggingText = !1, t.state.delayingBlurEvent && (t.hasFocus() ? t.state.delayingBlurEvent = !1 : fr(t)), 
                        Ce(o.wrapper.ownerDocument, "mouseup", s), Ce(o.wrapper.ownerDocument, "mousemove", a), 
                        Ce(o.scroller, "dragstart", u), Ce(o.scroller, "drop", s), l || (Te(e), i.addNew || Ai(t.doc, r, null, null, i.extend), 
                        d && !c || C && 9 == v ? setTimeout(function() {
                    ...
                    (t.state.draggingText = s).copy = !i.moveOnDrag, ye(o.wrapper.ownerDocument, "mouseup", s), 
                    ye(o.wrapper.ownerDocument, "mousemove", a), ye(o.scroller, "dragstart", u), ye(o.scroller, "drop", s), 
                    ...
                    function n(e) {
                        f.state.selectingText = !1, u = 1 / 0, e && (Te(e), l.input.focus()), Ce(l.wrapper.ownerDocument, "mousemove", r), 
                        Ce(l.wrapper.ownerDocument, "mouseup", i), g.history.lastSelOrigin = null;
                    }
            ...
            }(l, t, i, e) : Ae(e) == s.scroller && Te(e) : 2 == n ? (t && Ai(l.doc, t), setTimeout(function() {
        ...
        function nl(e, t) {
            var n, r;
            mn(e.display, t) || (r = t, ke(n = e, "gutterContextMenu") && el(n, r, "gutterContextMenu", !1)) || we(e, t, "contextmenu") || x || e.display.input.onContextMenu(t);
        }
        function rl(e) {
        ...
        function sl(e, t, n) {
            !t != !(n && n != il) && (n = e.display.dragFunctions, (t = t ? ye : Ce)(e.display.scroller, "dragstart", n.start), 
        ...
        function al(e) {
            ...
            Qn(e), tr(e), Pn(e), setTimeout(function() {
                return Nr(e);
            }, 100);
        }
        function ul(e, t) {
            ...
            Fr(this), this.state = {
                ...
                keySeq: null,
                specialChars: null
            }, t.autofocus && !h && o.input.focus(), C && v < 11 && setTimeout(function() {
                return n.display.input.reset(!0);
            }, 20), function(r) {
                var i = r.display;
                ye(i.scroller, "mousedown", Ir(r, Qo)), ye(i.scroller, "dblclick", C && v < 11 ? Ir(r, function(e) {
                    var t;
                    we(r, e) || (!(t = Jn(r, e)) || tl(r, e) || mn(r.display, e) || (Te(e), t = r.findWordAt(t), 
                ...
                ye(i.scroller, "touchstart", function(e) {
                    ...
                    r.setSelection(t.anchor, t.head), r.focus(), Te(e)), l();
                }), ye(i.scroller, "touchcancel", l), ye(i.scroller, "scroll", function() {
                    i.scroller.clientHeight && (kr(r, i.scroller.scrollTop), Tr(r, i.scroller.scrollLeft, !0), 
                    xe(r, "scroll", r));
                    ...
                    over: function(e) {
                        ...
                        t.display.lineSpace.insertBefore(t.display.dragCursor, t.display.cursorDiv)), T(t.display.dragCursor, n)), 
                        Oe(e));
                    },
                    start: function(e) {
                        return t = r, n = e, void (C && (!t.state.draggingText || +new Date() - fo < 100) ? Oe(n) : we(t, n) || mn(t.display, n) || (n.dataTransfer.setData("Text", t.getSelection()), 
                        n.dataTransfer.effectAllowed = "copyMove", n.dataTransfer.setDragImage && !c && ((e = M("img", null, null, "position: fixed; left: 0; top: 0;")).src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==", 
            ...
            }(this), yo(), Pr(this), this.curOp.forceUpdate = !0, vi(this, r), t.autofocus && !h || this.hasFocus() ? setTimeout(function() {
                n.hasFocus() && !n.state.focused && dr(n);
            }, 20) : pr(this), ll) ll.hasOwnProperty(i) && ll[i](this, t[i], il);
            $r(this), t.finishInit && t.finishInit(this);
            for (var l = 0; l < cl.length; ++l) cl[l](this);
            Wr(this), d && t.lineWrapping && "optimizelegibility" == getComputedStyle(o.lineDiv).textRendering && (o.lineDiv.style.textRendering = "auto");
        }
        ...
        function hl(e, t, n, r) {
            ...
            if (r || /\S/.test(s.text)) {
                if ("smart" == n && ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == z || 150 < u)) {
                    if (!r) return;
                    n = "prev";
                }
            } else u = 0, n = "not";
        ...
        function pl(e, t, n, r, i) {
            ...
            t && !s && ml(e, t), Cr(e), e.curOp.updateInput < 2 && (e.curOp.updateInput = h), 
        ...
        function bl() {
            var e = M("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none"), t = M("div", [ e ], null, "overflow: hidden; position: relative; width: 3px; height: 0px;");
            return d ? e.style.width = "1000px" : e.setAttribute("wrap", "off"), s && (e.style.border = "1px solid black"), 
            yl(e), t;
        }
        function Cl(i, o, l, s, a) {
            var e = o, t = l, u = Xe(i, o.line), c = a && "rtl" == i.direction ? -l : l;
            function n(e) {
                var t, n, r;
                if (null == (n = "codepoint" == s ? (t = u.text.charCodeAt(o.ch + (0 < l ? 0 : -1)), 
                isNaN(t) ? null : (n = 0 < l ? 55296 <= t && t < 56320 : 56320 <= t && t < 57343, 
                new rt(o.line, Math.max(0, Math.min(u.text.length, o.ch + l * (n ? 2 : 1))), -l))) : a ? Io(i.cm, u, o, l) : Wo(u, o, l))) {
                    if (e || (r = o.line + c) < i.first || r >= i.first + i.size || (o = new rt(r, o.ch, o.sticky), 
                    !(u = Xe(i, r)))) return;
                    o = Ho(a, i.cm, u, o.line, c);
                } else o = n;
                return 1;
            }
            if ("char" == s || "codepoint" == s) n(); else if ("column" == s) n(!0); else if ("word" == s || "group" == s) for (var r = null, h = "group" == s, f = i.cm && i.cm.getHelper(o, "wordChars"), d = !0; !(l < 0) || n(!d); d = !1) {
                var p = u.text.charAt(o.ch) || "\n", p = J(p, f) ? "w" : h && "\n" == p ? "n" : !h || /\s/.test(p) ? null : "p";
                if (!h || d || p || (p = "s"), r && r != p) {
                    l < 0 && (l = 1, n(), o.sticky = "after");
                    break;
                }
                if (p && (r = p), 0 < l && !n(!d)) break;
            }
            t = Ui(i, o, e, t, !0);
        ...
        e.prototype.init = function(e) {
            ...
            s.contentEditable = !0, yl(s, l.options.spellcheck, l.options.autocorrect, l.options.autocapitalize), 
            ye(s, "paste", function(e) {
                !a(e) || we(l, e) || gl(e, l) || v <= 11 && setTimeout(Ir(l, function() {
            ...
            if (t.display.viewTo == t.display.viewFrom || r.line >= t.display.viewTo || i.line < t.display.viewFrom) e.removeAllRanges(); else {
                ...
                if (!o || o.bad || !n || n.bad || 0 != it(at(o, n), r) || 0 != it(st(o, n), i)) {
                    var n = t.display.view, l = r.line >= t.display.viewFrom && wl(t, r) || {
                        node: n[0].measure.map[2],
                        offset: 0
                    }, s = i.line < t.display.viewTo && wl(t, i);
                    if (s || (s = {
            ...
            "nocursor" != this.cm.options.readOnly && (this.selectionInEditor() && A() == this.div || this.showSelection(this.prepareSelection(), !0), 
            this.div.focus());
        ...
        r.prototype.init = function(n) {
            ...
            ye(o, "input", function() {
                C && 9 <= v && e.hasSelection && (e.hasSelection = null), r.poll();
            }), ye(o, "paste", function(e) {
                we(i, e) || gl(e, i) || (i.state.pasteIncoming = +new Date(), r.fastPoll());
            ...
            return t.options.moveInputWithCursor && (e = zn(t, r.sel.primary().head, "div"), 
            ...
            T(t.cursorDiv, e.cursors), T(t.selectionDiv, e.selection), null != e.teTop && (this.wrapper.style.top = e.teTop + "px", 
            this.wrapper.style.left = e.teLeft + "px");
        }, r.prototype.reset = function(e) {
            var t, n;
            this.contextMenuPending || this.composing || ((t = this.cm).somethingSelected() ? (this.prevInput = "", 
            n = t.getSelection(), this.textarea.value = n, t.state.focused && P(this.textarea), 
            C && 9 <= v && (this.hasSelection = n)) : e || (this.prevInput = this.textarea.value = "", 
            C && 9 <= v && (this.hasSelection = null)));
            ...
            if (C && 9 <= v && this.hasSelection === i || g && /[\uf700-\uf7ff]/.test(i)) return t.display.input.reset(), 
            !1;
            ...
            C && 9 <= v && (this.hasSelection = null), this.fastPoll();
            ...
            function f() {
                ...
                o.style.cssText = l, C && v < 9 && i.scrollbars.setScrollTop(i.scroller.scrollTop = c), 
                null != o.selectionStart && ((!C || C && v < 9) && h(), e = 0, t = function() {
            ...
            i.selForContextMenu = r.doc.sel, clearTimeout(i.detectingSelectAll), C && 9 <= v && h(), 
            x ? (Oe(e), a = function() {
                Ce(window, "mouseup", a), setTimeout(f, 20);
        ...
        Tl = (Ll = ul).optionHandlers, Ll.defineOption = Al, Ll.Init = il, Al("value", "", function(e, t) {
            return e.setValue(t);
        ...
        }, !0), Al("rtlMoveVisually", !y), Al("wholeLineUpdateBefore", !0), Al("theme", "default", function(e) {
            rl(e), Zr(e);
        ...
        }, !0), Al("phrases", null), Nl = (Ml = ul).optionHandlers, Ol = Ml.helpers = {}, 
        Ml.prototype = {
            constructor: Ml,
            focus: function() {
            ...
            indentSelection: Er(function(e) {
                for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
                    var i = t[r];
                    if (i.empty()) i.head.line > n && (hl(this, i.head.line, e, !0), n = i.head.line, 
                    r == this.doc.sel.primIndex && Cr(this)); else {
                        ...
                        0 == o.ch && t.length == i.length && 0 < i[r].from().ch && Di(this.doc, r, new oi(o, i[r].to()), U);
                    }
                }
            }),
            ...
            cursorCoords: function(e, t) {
                ...
                return zn(this, n, t || "page");
            },
            charCoords: function(e, t) {
                return Bn(this, ct(this.doc, e), t || "page");
            },
            ...
            addWidget: function(e, t, n, r, i) {
                var o, l, s = this.display, a = (e = zn(this, ct(this.doc, e))).bottom, u = e.left;
                ...
                }, null != (t = yr(n, t)).scrollTop && kr(n, t.scrollTop), null != t.scrollLeft && Tr(n, t.scrollLeft));
            },
            ...
            findPosH: function(e, t, n, r) {
                var i = 1;
                t < 0 && (i = -1, t = -t);
                for (var o = ct(this.doc, e), l = 0; l < t && !(o = Cl(this.doc, o, i, n, r)).hitSide; ++l) ;
                return o;
            },
            moveH: Er(function(t, n) {
                var r = this;
                this.extendSelectionsBy(function(e) {
                    return r.display.shift || r.doc.extend || e.empty() ? Cl(r.doc, e.head, t, n, r.options.rtlMoveVisually) : t < 0 ? e.from() : e.to();
                }, G);
            }),
            ...
            moveV: Er(function(r, i) {
                ...
                if (l.extendSelectionsBy(function(e) {
                    ...
                    var t = zn(o, e.head, "div");
                    null != e.goalColumn && (t.left = e.goalColumn), s.push(t.left);
                    var n = xl(o, t, r, i);
                    return "page" == i && e == l.sel.primary() && br(o, Bn(o, n, "div").top - t.top), 
                    n;
            ...
            scrollIntoView: Er(function(e, t) {
                ...
                null == e ? (e = {
                    ...
                    from: e,
                    to: null
                }), e.to || (e.to = e.from), e.margin = t || 0, null != e.from.line ? (n = e, wr(t = this), 
            ...
            refresh: Er(function() {
                ...
                tr(this), this.curOp.forceUpdate = !0, Pn(this), xr(this, this.doc.scrollLeft, this.doc.scrollTop), 
                qr(this.display), (null == e || .5 < Math.abs(e - _n(this.display)) || this.options.lineWrapping) && Qn(this), 
                xe(this, "refresh", this);
            }),
            swapDoc: Er(function(e) {
                var t = this.doc;
                return t.cm = null, this.state.selectingText && this.state.selectingText(), vi(this, e), 
                Pn(this), this.display.input.reset(), xr(this, e.scrollLeft, e.scrollTop), this.curOp.forceScroll = !0, 
        ...
        }, Le(Ml), Ml.registerHelper = function(e, t, n) {
            Ol.hasOwnProperty(e) || (Ol[e] = Ml[e] = {
                _global: []
            }), Ol[e][t] = n;
        }, Ml.registerGlobalHelper = function(e, t, n, r) {
            Ml.registerHelper(e, t, r), Ol[e]._global.push({
                pred: n,
                val: r
            });
        };
        var Fl, Dl, Pl = "iter insert remove copy getEditor constructor".split(" ");
        for (Fl in ho.prototype) ho.prototype.hasOwnProperty(Fl) && R(Pl, Fl) < 0 && (ul.prototype[Fl] = function(e) {
            return function() {
        ...
        return Le(ho), ul.inputStyles = {
            ...
            if ((n = n ? H(n) : {}).value = t.value, !n.tabindex && t.tabIndex && (n.tabindex = t.tabIndex), 
            !n.placeholder && t.placeholder && (n.placeholder = t.placeholder), null == n.autofocus && (e = A(), 
            ...
            return s;
        }, (Dl = ul).off = Ce, Dl.on = ye, Dl.wheelEventPixels = ni, Dl.Doc = ho, Dl.splitLines = He, 
        Dl.countColumn = I, Dl.findColumn = V, Dl.isWordChar = Q, Dl.Pass = z, Dl.signal = xe, 
        Dl.Line = jt, Dl.changeEnd = ai, Dl.scrollbarModel = Ar, Dl.Pos = rt, Dl.cmpPos = it, 
        Dl.modes = Be, Dl.mimeModes = ze, Dl.resolveMode = Ue, Dl.getMode = Ke, Dl.modeExtensions = Ge, 
        Dl.extendMode = Ve, Dl.copyState = qe, Dl.startState = _e, Dl.innerMode = je, Dl.commands = Eo, 
        Dl.keyMap = ko, Dl.keyName = Ao, Dl.isModifierKey = No, Dl.lookupKey = Mo, Dl.normalizeKeyMap = To, 
        Dl.StringStream = $e, Dl.SharedTextMarker = ao, Dl.TextMarker = lo, Dl.LineWidget = ro, 
        Dl.e_preventDefault = Te, Dl.e_stopPropagation = Me, Dl.e_stop = Oe, Dl.addClass = F, 
        Dl.contains = O, Dl.rmClass = k, Dl.keyNames = Co, ul.version = "5.61.0", ul;
    }, (this || self).CodeMirror = t(), function(f) {
        "use strict";
        function t() {
        ...
        function C(e, t, n) {
            ...
            for (var r = n.line, i = n.ch, o = e.firstLine(); o <= r; r--, i = -1) {
                var l = e.getLine(r), l = b(l, t, i < 0 ? 0 : l.length - i);
                if (l) return {
                    from: y(r, l.index),
                    to: y(r, l.index + l[0].length),
                    match: l
        ...
        function r(n, r, e, t) {
            ...
            this.matches = function(e, t) {
                        ...
                        if (1 == o.length) {
                            ...
                            if (c.slice(0, f.length) == f) {
                                ...
                                if (h.slice(h.length - o[0].length) == o[0]) return {
                                    from: y(l + 1 - o.length, x(p, h, p.length - o[0].length, i)),
                                    to: y(l, x(u, c, f.length, i))
                                };
                            }
                        }
                    }
                    ...
                    s = 0) {
                        ...
                        if (1 == o.length) {
                            ...
                            if (-1 != h) {
                                n = x(u, c, h, i) + s;
                                return {
                                    from: y(l, x(u, c, h, i) + s),
                                    to: y(l, x(u, c, h + o[0].length, i) + s)
                                };
                            }
                        } else {
                            ...
                            if (c.slice(f) == o[0]) {
                                ...
                                if (g.slice(0, h.length) == h) return {
                                    from: y(l, x(u, c, f, i) + s),
                                    to: y(l + o.length - 1, x(p, g, h.length, i))
                                };
                            }
                        }
                    }
                ...
                return (e ? function(e, t, n) {
                    if (!g(t)) return C(e, t, n);
                    t = p(t, "gm");
                    for (var r = 1, i = e.getLine(n.line).length - n.ch, o = n.line, l = e.firstLine(); l <= o; ) {
                        for (var s = 0; s < r && l <= o; s++) var a = e.getLine(o--), u = null == u ? a : a + "\n" + u;
                        r *= 2;
                        var c = b(u, t, i);
                        if (c) {
                            var h = u.slice(0, c.index).split("\n"), f = c[0].split("\n"), d = o + h.length, h = h[h.length - 1].length;
                            return {
                                from: y(d, h),
                                to: y(d + f.length - 1, 1 == f.length ? h + f[0].length : f[f.length - 1].length),
                                match: c
                            };
                        }
                    }
                } : function(e, t, n) {
                    if (!g(t)) return d(e, t, n);
                    t = p(t, "gm");
        ...
        h.defineExtension("openDialog", function(e, t, n) {
            ...
            }), !1 !== n.closeOnBlur && h.on(r, "focusout", function(e) {
                null !== e.relatedTarget && l();
            })) : (e = r.getElementsByTagName("button")[0]) && (h.on(e, "click", function() {
                l(), o.focus();
        ...
        function i(i, o, e, l) {
            ...
            u = t(!1);
            u && !u.cleared && "unfold" !== l && (n = function(e, t, n) {
                t = h(e, t, "widget");
                "function" == typeof t && (t = t(n.from, n.to));
                {
                    "string" == typeof t ? (n = document.createTextNode(t), (t = document.createElement("span")).appendChild(n), 
                    t.className = "CodeMirror-foldmarker") : t = t && t.cloneNode(!0);
                }
                return t;
            }(i, e, u), c.on(n, "mousedown", function(e) {
        ...
        r.defineOption("foldGutter", !1, function(e, t, n) {
            ...
            e.off("gutterClick", s), e.off("changes", a), e.off("viewportChange", u), e.off("fold", c), 
            e.off("unfold", c), e.off("swapDoc", a)), t && (e.state.foldGutter = new i(function(e) {
                !0 === e && (e = {});
                ...
                return e;
            }(t)), l(e), e.on("gutterClick", s), e.on("changes", a), e.on("viewportChange", u), 
            e.on("fold", c), e.on("unfold", c), e.on("swapDoc", a));
        });
        var h = r.Pos;
        function i(e) {
        ...
        function f(e, t) {
            for (var n = e.findMarks(h(t, 0), h(t + 1, 0)), r = 0; r < n.length; ++r) if (n[r].__isFold) {
                var i = n[r].find(-1);
        ...
        function o(i, e, t) {
            var o = i.state.foldGutter.options, l = e - 1, s = i.foldOption(o, "minFoldSize"), a = i.foldOption(o, "rangeFinder"), u = "string" == typeof o.indicatorFolded && n(o.indicatorFolded), c = "string" == typeof o.indicatorOpen && n(o.indicatorOpen);
            i.eachLine(e, t, function(e) {
                ++l;
                var t = null, n = (n = e.gutterMarkers) && n[o.gutter];
                if (f(i, l)) {
                    if (u && n && u.test(n.className)) return;
                    t = d(o.indicatorFolded);
                } else {
                    var r = h(l, 0), r = a && a(i, r);
                    if (r && r.to.line - r.from.line >= s) {
                        if (c && n && c.test(n.className)) return;
                        t = d(o.indicatorOpen);
                    }
                }
                (t || n) && i.setGutterMarker(e, o.gutter, t);
            });
        }
        function n(e) {
            return new RegExp("(^|\\s)" + e + "(?:$|\\s)\\s*");
        ...
        function s(e, t, n) {
            ...
            !r || n == (n = r.options).gutter && ((r = f(e, t)) ? r.clear() : e.foldCode(h(t, 0), n));
        }
        function a(e) {
        ...
        function r(e, t) {
            ...
            this.options.updateOnCursorActivity && (n = this, e.on("cursorActivity", this.activityFunc = function() {
                n.cursorActivity();
            }));
        }
        M.showHint = function(e, t, n) {
            ...
            return e.showHint(r);
        }, M.defineExtension("showHint", function(e) {
            e = function(e, t, n) {
            ...
            if (!(1 < t.length)) {
                ...
                e.options.hint && (M.signal(this, "startCompletion", this), e.update(!0));
            }
        }), M.defineExtension("closeHint", function() {
            this.state.completionActive && this.state.completionActive.close();
        });
        ...
        function n(i, e) {
            ...
            for (var r = e.list, u = 0; u < r.length; ++u) {
                var c = a.appendChild(l.createElement("li")), h = r[u], f = "CodeMirror-hint" + (u != this.selectedHint ? "" : " " + N);
                null != h.className && (f = h.className + " " + f), c.className = f, h.render ? h.render(c, e, h) : c.appendChild(l.createTextNode(h.displayText || O(h))), 
                c.hintId = u;
            }
            var d = i.options.container || l.body, p = o.cursorCoords(i.options.alignWithWord ? e.from : null), g = p.left, m = p.bottom, v = !0, y = 0, b = 0;
            d !== l.body && (C = (S = -1 !== [ "absolute", "relative", "fixed" ].indexOf(s.getComputedStyle(d).position) ? d : d.offsetParent).getBoundingClientRect(), 
            w = l.body.getBoundingClientRect(), y = C.left - w.left - S.scrollLeft, b = C.top - w.top - S.scrollTop), 
            a.style.left = g - y + "px", a.style.top = m - b + "px";
            var t = s.innerWidth || Math.max(l.body.offsetWidth, l.documentElement.offsetWidth), C = s.innerHeight || Math.max(l.body.offsetHeight, l.documentElement.offsetHeight);
            d.appendChild(a);
            var x, w = i.options.moveOnOverlap ? a.getBoundingClientRect() : new DOMRect(), S = !!i.options.paddingForScrollbar && a.scrollHeight > a.clientHeight + 1;
            setTimeout(function() {
                x = o.getScrollInfo();
            }), 0 < w.bottom - C && (d = w.bottom - w.top, 0 < p.top - (p.bottom - w.top) - d ? (a.style.top = (m = p.top - d - b) + "px", 
            v = !1) : C < d && (a.style.height = C - 5 + "px", a.style.top = (m = p.bottom - w.top - b) + "px", 
            L = o.getCursor(), e.from.ch != L.ch && (p = o.cursorCoords(L), a.style.left = (g = p.left - y) + "px", 
            w = a.getBoundingClientRect())));
            var k, L = w.right - t;
            if (S && (L += o.display.nativeBarWidth), 0 < L && (w.right - w.left > t && (a.style.width = t - 5 + "px", 
            L -= w.right - w.left - t), a.style.left = (g = p.left - L - y) + "px"), S) for (var T = a.firstChild; T; T = T.nextSibling) T.style.paddingRight = o.display.nativeBarWidth + "px";
            o.addKeyMap(this.keyMap = function(e, r) {
                ...
                var e = o.getScrollInfo(), t = o.getWrapperElement().getBoundingClientRect();
                x = x || o.getScrollInfo();
                var n = m + x.top - e.top, r = n - (s.pageYOffset || (l.documentElement || l.body).scrollTop);
                if (v || (r += a.offsetHeight), r <= t.top || r >= t.bottom) return i.close();
                a.style.top = n + "px", a.style.left = g + x.left - e.left + "px";
            }), M.on(a, "dblclick", function(e) {
                e = A(a, e.target || e.srcElement);
                e && null != e.hintId && (n.changeActive(e.hintId), n.pick());
            }), M.on(a, "click", function(e) {
                e = A(a, e.target || e.srcElement);
                e && null != e.hintId && (n.changeActive(e.hintId), i.options.completeOnSingleClick && n.pick());
            }), M.on(a, "mousedown", function() {
                setTimeout(function() {
                    o.focus();
                }, 20);
            });
            S = this.getSelectedHintRange();
            return 0 === S.from && 0 === S.to || this.scrollToActive(), M.signal(e, "select", r[this.selectedHint], a.childNodes[this.selectedHint]), 
            !0;
        }
        function s(e, t, n, r) {
        ...
        r.prototype = {
            close: function() {
                this.active() && (this.cm.state.completionActive = null, this.tick = null, this.options.updateOnCursorActivity && this.cm.off("cursorActivity", this.activityFunc), 
                this.widget && this.data && M.signal(this.data, "close"), this.widget && this.widget.close(), 
                M.signal(this.cm, "endCompletion", this.cm));
            },
            active: function() {
                return this.cm.state.completionActive == this;
            },
            pick: function(e, t) {
                var n = e.list[t], r = this;
                this.cm.operation(function() {
                    n.hint ? n.hint(r.cm, e, n) : r.cm.replaceRange(O(n), n.from || e.from, n.to || e.to, "complete"), 
                    M.signal(e, "pick", n), r.cm.scrollIntoView();
            ...
            cursorActivity: function() {
                ...
                var t, n = this.cm.getCursor(), r = this.cm.getLine(n.line);
                n.line != this.startPos.line || r.length - n.ch != this.startLen - this.startPos.ch || n.ch < e.ch || this.cm.somethingSelected() || !n.ch || this.options.closeCharacters.test(r.charAt(n.ch - 1)) ? this.close() : ((t = this).debounce = i(function() {
                    t.update();
            ...
            finishUpdate: function(e, t) {
                this.data && M.signal(this.data, "update");
            ...
            close: function() {
                var e;
                this.completion.widget == this && (this.completion.widget = null, this.hints.parentNode && this.hints.parentNode.removeChild(this.hints), 
            ...
            changeActive: function(e, t) {
                ...
                this.selectedHint != e && ((t = this.hints.childNodes[this.selectedHint]) && (t.className = t.className.replace(" " + N, "")), 
                (t = this.hints.childNodes[this.selectedHint = e]).className += " " + N, this.scrollToActive(), 
                M.signal(this.data, "select", this.data.list[this.selectedHint], t));
            },
            scrollToActive: function() {
                var e = this.getSelectedHintRange(), t = this.hints.childNodes[e.from], n = this.hints.childNodes[e.to], e = this.hints.firstChild;
            ...
            resolve: function(e, t) {
                ...
                return (n = e.getHelper(e.getCursor(), "hintWords")) ? function(e) {
                    return M.hint.fromList(e, {
                        words: n
                    });
                } : M.hint.anyword ? function(e, t) {
                    return M.hint.anyword(e, t);
                } : function() {};
            }
        }), M.registerHelper("hint", "fromList", function(e, t) {
            var n, r = e.getCursor(), i = e.getTokenAt(r), o = M.Pos(r.line, i.start), e = r;
        ...
        }), M.commands.autocomplete = M.showHint;
        var l = {
            hint: M.hint.auto,
            completeSingle: !0,
            alignWithWord: !0,
        ...
        M.defineOption("hintOptions", null);
        ...
        N.registerHelper("hint", "xml", function(e, t) {
            var n = t && t.schemaInfo, r = t && t.quoteChar || '"', i = t && t.matchInMiddle;
            if (n) {
                var o = e.getCursor(), l = e.getTokenAt(o);
                if (l.end > o.ch && (l.end = o.ch, l.string = l.string.slice(0, o.ch - l.start)), 
                (p = N.innerMode(e.getMode(), l.state)).mode.xmlCurrentTag) {
                    var s, a, u, c = [], h = !1, f = /\btag\b/.test(l.type) && !/>$/.test(l.string), d = f && /^\w/.test(l.string);
                    d ? (L = e.getLine(o.line).slice(Math.max(0, l.start - 2), l.start), (u = /<\/$/.test(L) ? "close" : /<$/.test(L) ? "open" : null) && (a = l.start - ("close" == u ? 2 : 1))) : f && "<" == l.string ? u = "open" : f && "</" == l.string && (u = "close");
                    t = p.mode.xmlCurrentTag(p.state);
                    if (!f && !t || u) {
                        d && (s = l.string), h = u;
                        var p, g = p.mode.xmlCurrentContext ? p.mode.xmlCurrentContext(p.state) : [], g = (p = g.length && g[g.length - 1]) && n[p], m = p ? g && g.children : n["!top"];
                        if (m && "close" != u) for (var v = 0; v < m.length; ++v) s && !A(m[v], s, i) || c.push("<" + m[v]); else if ("close" != u) for (var y in n) !n.hasOwnProperty(y) || "!top" == y || "!attrs" == y || s && !A(y, s, i) || c.push("<" + y);
                        p && (!s || "close" == u && A(p, s, i)) && c.push("</" + p + ">");
                    } else {
                        var b, C = (g = t && n[t.name]) && g.attrs, x = n["!attrs"];
                        if (!C && !x) return;
                        if (C) {
                            if (x) {
                                var w, S = {};
                                for (w in x) x.hasOwnProperty(w) && (S[w] = x[w]);
                                for (w in C) C.hasOwnProperty(w) && (S[w] = C[w]);
                                C = S;
                            }
                        } else C = x;
                        if ("string" == l.type || "=" == l.string) {
                            var k, L, g = (L = e.getRange(O(o.line, Math.max(0, o.ch - 60)), O(o.line, "string" == l.type ? l.start : l.end))).match(/([^\s\u00a0=<>\"\']+)=$/);
                            if (!g || !C.hasOwnProperty(g[1]) || !(k = C[g[1]])) return;
                            "function" == typeof k && (k = k.call(this, e)), "string" == l.type && (s = l.string, 
                            L = 0, /['"]/.test(l.string.charAt(0)) && (r = l.string.charAt(0), s = l.string.slice(1), 
                            L++), g = l.string.length, /['"]/.test(l.string.charAt(g - 1)) && (r = l.string.charAt(g - 1), 
                            s = l.string.substr(L, g - 2)), !L || (T = e.getLine(o.line)).length > l.end && T.charAt(l.end) == r && l.end++, 
                            h = !0);
                            var T = function(e) {
                                if (e) for (var t = 0; t < e.length; ++t) s && !A(e[t], s, i) || c.push(r + e[t] + r);
                                return M();
                            };
                            return k && k.then ? k.then(T) : T(k);
                        }
                        for (b in "attribute" == l.type && (s = l.string, h = !0), C) !C.hasOwnProperty(b) || s && !A(b, s, i) || c.push(b);
                    }
                    return M();
                }
            }
            function M() {
                return {
                    list: c,
                    from: h ? O(o.line, null == a ? l.start : a) : o,
                    to: h ? O(o.line, l.end) : o
                };
            }
        });
    }(CodeMirror), function(i) {
        ...
        S.defineMode("xml", function(e, t) {
            ...
            function x(e, t, n) {
                return "string" == e ? w : "word" == e && a.allowUnquoted ? (l = "string", b) : (l = "error", 
                b(e, 0, n));
            }
            function w(e, t, n) {
                return "string" == e ? w : b(e, 0, n);
            }
            return u.isInText = !0, {
        ...
        h.defineMode("htmlmixed", function(s, e) {
            var a = h.getMode(s, {
                ...
                allowMissingTagName: e.allowMissingTagName
        ...
        "use strict";
        var r = h.commands, f = h.Pos;
        function t(t, n) {
            t.extendSelectionsBy(function(e) {
                return t.display.shift || t.doc.extend || e.empty() ? function(e, t, n) {
                    if (n < 0 && 0 == t.ch) return e.clipPos(f(t.line - 1));
                    var r = e.getLine(t.line);
                    if (0 < n && t.ch >= r.length) return e.clipPos(f(t.line + 1, 0));
                    for (var i, o = "start", l = t.ch, s = l, a = n < 0 ? 0 : r.length; s != a; s += n, 
                    0) {
                        var u = r.charAt(n < 0 ? s - 1 : s), c = "_" != u && h.isWordChar(u) ? "w" : "o";
                        if ("w" == c && u.toUpperCase() == u && (c = "W"), "start" == o) "o" != c ? (o = "in", 
                        i = c) : l = s + n; else if ("in" == o && i != c) {
                            if ("w" == i && "W" == c && n < 0 && s--, "W" == i && "w" == c && 0 < n) {
                                if (s == l + 1) {
                                    i = "w";
                                    continue;
                                }
        ...
        r.goSubwordLeft = function(e) {
            ...
            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++) {
                var i = t[r];
                n.push({
                    anchor: f(i.from().line, 0),
                    head: f(i.to().line + 1, 0)
                });
            }
            e.setSelections(n);
        }, r.insertLineAfter = function(e) {
            return n(e, !1);
        }, r.insertLineBefore = function(e) {
            return n(e, !0);
        }, r.selectNextOccurrence = function(e) {
            ...
            if (0 == h.cmpPos(t, n)) {
                ...
                if (!(n.findNext() || (n = e.getSearchCursor(t, f(e.firstLine(), 0))).findNext()) || function(e, t, n) {
                    for (var r = 0; r < e.length; r++) if (0 == h.cmpPos(e[r].from(), t) && 0 == h.cmpPos(e[r].to(), n)) return !0;
                    return !1;
                }(e.listSelections(), n.from(), n.to())) return;
            ...
            r.selectNextOccurrence(e), 0 != h.cmpPos(t, n) && e.doc.setSelections(e.doc.listSelections().filter(function(e) {
                return e.anchor != t || e.head != n;
            }));
        }, r.addCursorToPrevLine = function(e) {
            i(e, -1);
            ...
            for (var t = e.listSelections(), n = [], r = 0; r < t.length; r++) {
                ...
                for (;;) {
                    ...
                    if (s.ch == "(){}[]".charAt("(){}[]".indexOf(l.ch) + 1)) {
                        var a = f(l.pos.line, l.pos.ch + 1);
                        if (0 != h.cmpPos(a, i.from()) || 0 != h.cmpPos(s.pos, i.to())) {
                            n.push({
                                anchor: a,
                                head: s.pos
                            });
        ...
        function s(l, s, a) {
            if (l.isReadOnly()) return h.Pass;
            for (var u, e = l.listSelections(), c = [], t = 0; t < e.length; t++) {
                var n = e[t];
                if (!n.empty()) {
            ...
            c.length ? u = !0 : c.push(l.firstLine(), l.lastLine()), l.operation(function() {
                for (var e = [], t = 0; t < c.length; t += 2) {
                    var n = c[t], r = c[t + 1], i = f(n, 0), o = f(r), n = l.getRange(i, o, !1);
                    s ? n.sort(function(e, t) {
                        return e < t ? -a : e == t ? 0 : a;
                    }) : n.sort(function(e, t) {
                        var n = e.toUpperCase(), r = t.toUpperCase();
                        return n != r && (e = n, t = r), e < t ? -a : e == t ? 0 : a;
                    }), l.replaceRange(n, i, o), u && e.push({
                        anchor: i,
                        head: f(r + 1, 0)
                    });
                }
                u && l.setSelections(e, 0);
            });
        }
        function a(s, a) {
            s.operation(function() {
                ...
                for (r = t.length - 1; 0 <= r; r--) {
                    var i, o, l = e[t[r]];
                    o && 0 < h.cmpPos(l.head, o) || (o = (i = u(s, l.head)).from, s.replaceRange(a(i.word), i.from, i.to));
                }
            });
        }
        function c(e) {
        ...
        function d(e, t) {
            var n, r, i = c(e);
            i && (n = i.query, r = e.getSearchCursor(n, t ? i.to : i.from), (t ? r.findNext() : r.findPrevious()) ? e.setSelection(r.from(), r.to()) : (r = e.getSearchCursor(n, t ? f(e.firstLine(), 0) : e.clipPos(f(e.lastLine()))), 
            (t ? r.findNext() : r.findPrevious()) ? e.setSelection(r.from(), r.to()) : i.word && e.setSelection(i.from, i.to)));
        }
        r.selectScope = function(e) {
            o(e) || e.execCommand("selectAll");
        }, r.selectBetweenBrackets = function(e) {
            if (!o(e)) return h.Pass;
        }, r.goToBracket = function(n) {
            n.extendSelectionsBy(function(e) {
                var t = n.scanForBracket(e.head, 1, l(n.getTokenTypeAt(e.head)));
                if (t && 0 != h.cmpPos(t.pos, e.head)) return t.pos;
                t = n.scanForBracket(e.head, -1, l(n.getTokenTypeAt(f(e.head.line, e.head.ch + 1))));
                return t && f(t.pos.line, t.pos.ch + 1) || e.head;
            });
        }, r.swapLineUp = function(i) {
            if (i.isReadOnly()) return h.Pass;
            for (var e = i.listSelections(), o = [], t = i.firstLine() - 1, l = [], n = 0; n < e.length; n++) {
                var r = e[n], s = r.from().line - 1, a = r.to().line;
                l.push({
                    anchor: f(r.anchor.line - 1, r.anchor.ch),
                    head: f(r.head.line - 1, r.head.ch)
            ...
            i.operation(function() {
                for (var e = 0; e < o.length; e += 2) {
                    ...
                    i.replaceRange("", f(t, 0), f(t + 1, 0), "+swapLine"), n > i.lastLine() ? i.replaceRange("\n" + r, f(i.lastLine()), null, "+swapLine") : i.replaceRange(r + "\n", f(n, 0), null, "+swapLine");
                }
                i.setSelections(l), i.scrollIntoView();
            });
        }, r.swapLineDown = function(i) {
            if (i.isReadOnly()) return h.Pass;
            ...
            i.operation(function() {
                for (var e = o.length - 2; 0 <= e; e -= 2) {
                    var t = o[e], n = o[e + 1], r = i.getLine(t);
                    t == i.lastLine() ? i.replaceRange("", f(t - 1), f(t), "+swapLine") : i.replaceRange("", f(t, 0), f(t + 1, 0), "+swapLine"), 
                    i.replaceRange(r + "\n", f(n, 0), null, "+swapLine");
                }
                i.scrollIntoView();
            });
            ...
            a.operation(function() {
                for (var e = 0, t = [], n = 0; n < u.length; n++) {
                    for (var r, i = u[n], o = i.anchor && f(i.anchor.line - e, i.anchor.ch), l = i.start; l <= i.end; l++) {
                        var s = l - e;
                        l == i.end && (r = f(s, a.getLine(s).length + 1)), s < a.lastLine() && (a.replaceRange(" ", f(s), f(1 + s, /^\s*/.exec(a.getLine(1 + s))[0].length)), 
                        ++e);
                    }
                    t.push({
                        anchor: o || r,
        ...
        }, r.smartBackspace = function(s) {
            if (s.somethingSelected()) return h.Pass;
            s.operation(function() {
                for (var e = s.listSelections(), t = s.getOption("indentUnit"), n = e.length - 1; 0 <= n; n--) {
                    var r = e[n].head, i = s.getRange({
                        line: r.line,
                        ch: 0
                    }, r), o = h.countColumn(i, null, s.getOption("tabSize")), l = s.findPosH(r, -1, "char", !1);
                    !i || /\S/.test(i) || o % t != 0 || (o = new f(r.line, h.findColumn(i, o - t, t))).ch != r.ch && (l = o), 
                    s.replaceRange("", l, r, "+delete");
                }
            });
        }, r.delLineRight = function(n) {
            n.operation(function() {
                for (var e = n.listSelections(), t = e.length - 1; 0 <= t; t--) n.replaceRange("", e[t].anchor, f(e[t].to().line), "+delete");
                n.scrollIntoView();
            });
            ...
            r && (n = e.getCursor(), t = r, 0 < h.cmpPos(n, t) && (r = t, t = n, n = r), e.state.sublimeKilled = e.getRange(n, t), 
            e.replaceRange("", n, t));
        ...
        }, h.normalizeKeyMap(e.macSublime), e.pcSublime = {
            "Shift-Tab": "indentLess",
            "Shift-Ctrl-K": "deleteLine",
            "Alt-Q": "wrapLines",
            "Ctrl-T": "transposeChars",
        ...
        }, h.normalizeKeyMap(e.pcSublime);
        var p = e.default == e.macDefault;
        e.sublime = p ? e.macSublime : e.pcSublime;
    }(CodeMirror);
